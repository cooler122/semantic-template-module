...
public interface SimilarityCalculateService {
     ...
     * @param similarityCalculationData_lpm    此为日志数据记录对象，如果用户启动日志模式，则此值传入的是一个非空对象，反之则传入null
     * @return
     */
    SVRuleInfo similarityCalculate_LPM(Integer algorithmType, SVRuleInfo historySvRuleInfo, Map<String, RRuleEntity> rRuleEntityMap, SimilarityCalculationData_LPM similarityCalculationData_lpm);
}
